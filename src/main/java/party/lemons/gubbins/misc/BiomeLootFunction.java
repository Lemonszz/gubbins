...
public class BiomeLootFunction extends ConditionalLootFunction
{
	...
	public static class Factory extends ConditionalLootFunction.Factory<BiomeLootFunction>
	{
		public Factory()
		{
			super(new Identifier(Gubbins.MODID, "biome_map"), BiomeLootFunction.class);
		}
