...
public class GubbinsBlocks
{
	...
	public static final Block MOSSY_STONE = new LayeredBlock(settings(Material.STONE, 1.5F).build());
	public static final Block HARDENED_DIRT = new LayeredBlock(settings(Material.STONE, 1.0F).sounds(BlockSoundGroup.GRAVEL).build());
