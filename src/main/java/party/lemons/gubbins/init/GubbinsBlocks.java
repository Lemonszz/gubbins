...
import party.lemons.gubbins.block.*;
...
{
	public static final Block AMETHYST_ORE = new GubbinsOreBlock(settings(Material.STONE, 1.5F).breakByTool(FabricToolTags.PICKAXES, 2).build(), 7, 12);
	public static final Block GARNET_ORE = new GubbinsOreBlock(settings(Material.STONE, 1.5F).breakByTool(FabricToolTags.PICKAXES, 2).sounds(BlockSoundGroup.NETHER_ORE).build(), 7, 12);
	public static final Block ONYX_ORE = new GubbinsOreBlock(settings(Material.STONE, 1.5F).breakByTool(FabricToolTags.PICKAXES, 2).build(), 7, 12);
	public static final Block DIAMOND_ICE_ORE = new GubbinsOreBlock(settings(Material.DENSE_ICE, 1.5F).breakByTool(FabricToolTags.PICKAXES, 3).build(), 3, 7);
	public static final Block GOLD_ICE_ORE = new GubbinsOreBlock(settings(Material.DENSE_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 2).build(), 0, 0);
	public static final Block REDSTONE_ICE_ORE = new GubbinsOreBlock(settings(Material.DENSE_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 2).build(), 1, 5);
	public static final Block COAL_ICE_ORE = new GubbinsOreBlock(settings(Material.DENSE_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 0).build(), 0, 2);
	public static final Block IRON_ICE_ORE = new GubbinsOreBlock(settings(Material.DENSE_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 1).build(), 0, 0);
	...
	public static final Block HARDENED_DIRT = new HardenedDirtBlock(settings(Material.STONE, 1.0F).sounds(BlockSoundGroup.GRAVEL).build());
	public static final Block HARDENED_DIRT_BRICKS = new HardenedDirtBlock(settings(Material.STONE, 1.5F).sounds(BlockSoundGroup.GRAVEL).build());
	...
	public static final DecorationBlockInfo HARDENED_DIRT_DECORATION = new DecorationBlockInfo("hardened_dirt", HARDENED_DIRT, settings(Material.STONE, 1.0F).sounds(BlockSoundGroup.GRAVEL).build(), GubbinsUtil::addShovelableBlock).all();
	public static final DecorationBlockInfo HARDENED_DIRT_BRICK_DECORATION = new DecorationBlockInfo("hardened_dirt_brick", HARDENED_DIRT_BRICKS, settings(Material.STONE, 1.5F).sounds(BlockSoundGroup.GRAVEL).build(),  GubbinsUtil::addShovelableBlock).all();
