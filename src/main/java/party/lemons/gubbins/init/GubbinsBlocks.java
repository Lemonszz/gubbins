...
public class GubbinsBlocks
{
	...
	public static final Block DIAMOND_ICE_ORE = new TranslucentBlock(settings(Material.PACKED_ICE, 1.5F).breakByTool(FabricToolTags.PICKAXES, 3).build());
	public static final Block GOLD_ICE_ORE = new TranslucentBlock(settings(Material.PACKED_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 2).build());
	public static final Block REDSTONE_ICE_ORE = new TranslucentBlock(settings(Material.PACKED_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 2).build());
	public static final Block COAL_ICE_ORE = new TranslucentBlock(settings(Material.PACKED_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 0).build());
	public static final Block IRON_ICE_ORE = new TranslucentBlock(settings(Material.PACKED_ICE, 1.5F).sounds(BlockSoundGroup.GLASS).breakByTool(FabricToolTags.PICKAXES, 1).build());
	...
	public static final Block WARPED_POD = new WarpedPodBlock(settings(Material.ORGANIC, 0F).noCollision().ticksRandomly().sounds(BlockSoundGroup.NETHER_WART).nonOpaque().build());
