...
public class IceCarver extends CaveCarver
{
	...
	public IceCarver(Codec<ProbabilityConfig> function, int i)
	{
		super(function, i);
	...
	public boolean iceCarveAtPoint(Chunk chunk, Function<BlockPos, Biome> posToBiome, BitSet carvingMask, Random random, BlockPos.Mutable mutable, BlockPos.Mutable mutable2, BlockPos.Mutable mutable3, int seaLevel, int mainChunkX, int mainChunkZ, int x, int z, int relativeX, int y, int relativeZ, MutableBoolean foundSurface) {
