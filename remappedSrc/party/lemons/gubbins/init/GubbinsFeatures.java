...
public class GubbinsFeatures
{
	...
	public static final CaveBiomeFeature CAVE_BIOME = new CaveBiomeFeature(DefaultFeatureConfig.CODEC);
	public static final WarpedPodFeature WARPED_POD = new WarpedPodFeature(DefaultFeatureConfig.CODEC);
}
