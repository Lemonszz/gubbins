...
public class SpecialModels
{
	public static final SpecialModel[] MODELS = new SpecialModel[]{
		new SpecialModel(new Identifier(Gubbins.MODID, "sticky_item_frame"), ((StateManager.Builder<Block, BlockState>)(new StateManager.Builder(Blocks.AIR)).add(BooleanProperty.of("map"))).build(Block::getDefaultState, BlockState::new))
	};
