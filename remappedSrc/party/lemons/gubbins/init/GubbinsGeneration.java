...
import party.lemons.gubbins.util.BiomeUtil;
...
public class GubbinsGeneration
{
	...
	{
		BiomeUtil.gatherBiomeFromCategory(Biome.Category.THEEND, AMETHYST_BIOMES);
		BiomeUtil.gatherBiomeFromCategory(Biome.Category.NETHER, GARNET_BIOMES);
		BiomeUtil.gatherBiomeFromCategory(Biome.Category.OCEAN, ONYX_BIOMES);
		BiomeUtil.gatherBiomeFromCategory(Biome.Category.ICY, ICY);
		...
		if(Gubbins.config.MISC.enableMansionInSnowTundra)
			Biomes.SNOWY_TUNDRA.addStructureFeature(StructureFeature.MANSION.configure(DefaultFeatureConfig.INSTANCE));
