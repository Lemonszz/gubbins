...
{
	public static final IceRavineCarver ICE_RAVINE = new IceRavineCarver(ProbabilityConfig.CODEC);
	public static final IceCarver ICE_CAVE = new IceCarver(ProbabilityConfig.CODEC, 256);
}
